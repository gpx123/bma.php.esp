...
define('ESP_MODULE_PATH', __DIR__.'/../modules/');	//esp基础库目录
define('BMA_LIBS_PATH', __DIR__.'/../../common/libs/');
define('BMA_MODULE_PATH', __DIR__.'/../../common/modules/');

# 加载环境启动配置
require_once APP_PATH.'conf/env.conf.php';

# 指定 应用配置/模块配置 目录
define('APP_CONFIG_PATH',__DIR__.'/conf/');
