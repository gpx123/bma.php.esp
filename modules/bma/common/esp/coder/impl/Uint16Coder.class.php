 ...
 * @desc Uint16Coder
 *
 * @category  Uint16Coder.class.php
 * @package   
...
class Uint16Coder implements coder\BaseCoder {

    private static $_instance;

    /**
     * 
     * @return \bma\common\esp\coder\impl\Uint16Coder
     */
    ...
    public function decoder($buf) {
        return Uint16Coder::uint64Decoder($buf);
    }

    public function encoder($buf, $obj) {
        return Uint16Coder::uint64Encoder($buf, $obj);
    }
}
