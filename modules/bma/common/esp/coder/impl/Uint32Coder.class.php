 ...
 * @desc Uint32Coder
 *
 * @category  Uint32Coder.class.php
 * @package   
...
class Uint32Coder implements coder\BaseCoder {

    private static $_instance;

    /**
     * 
     * @return \bma\common\esp\coder\impl\Uint32Coder
     */
    ...
    public function decoder($buf) {
        return Uint32Coder::uint64Decoder($buf);
    }

    public function encoder($buf, $obj) {
        return Uint32Coder::uint64Encoder($buf, $obj);
    }
}
